//! `inputctl-vision` is a vision-based GUI automation toolkit for Linux (Wayland).
//!
//! It provides tools for LLM-based image analysis and programmatic control of the
//! mouse and keyboard. It is designed to be used both for simple script-driven
//! automation and for building autonomous agents.
//!
//! Screen capture primitives are provided by the `inputctl-capture` crate.
//!
//! # Core Components
...
mod python {
    ...
    #[pymodule]
    fn inputctl_vision(m: &Bound<'_, PyModule>) -> PyResult<()> {
