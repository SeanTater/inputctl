...
pub fn create_device() -> Result<VirtualDevice> {
    ...
    for key in [
        Key::KEY_SPACE, Key::KEY_MINUS, Key::KEY_EQUAL, Key::KEY_LEFTBRACE,
        Key::KEY_RIGHTBRACE, Key::KEY_BACKSLASH, Key::KEY_SEMICOLON,
        Key::KEY_APOSTROPHE, Key::KEY_GRAVE, Key::KEY_COMMA, Key::KEY_DOT,
        Key::KEY_SLASH, Key::KEY_TAB, Key::KEY_ENTER, Key::KEY_BACKSPACE,
    ] {
        keys.insert(key);
    }
    ...
    // Function keys
    for key in [
        Key::KEY_ESC, Key::KEY_F1, Key::KEY_F2, Key::KEY_F3, Key::KEY_F4,
        Key::KEY_F5, Key::KEY_F6, Key::KEY_F7, Key::KEY_F8, Key::KEY_F9,
        Key::KEY_F10, Key::KEY_F11, Key::KEY_F12,
    ] {
        keys.insert(key);
    }
